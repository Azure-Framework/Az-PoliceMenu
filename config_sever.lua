...
Config.clock_webhook_url = "https://discord.com/api/webhooks/123/abc"  -- <- PUT YOUR WEBHOOK HERE
...
Config.CAD = {
    ...
    resourceName = "Az-FirstResponse",    -- resource name to check (adjust if different)
